...
const HeroSection = () => {
  ...
  return (
    <div className="relative bg-no-repeat bg-cover bg-center h-screen" style={{ backgroundImage: `url(${HeroImg})` }}>
      <div className="absolute inset-0 bg-black bg-opacity-50"></div>
      <div className="relative z-10 flex flex-col items-center justify-center text-center h-full text-white">
        <h1 className="text-4xl font-bold mb-4">Welcome to Your Social Media App</h1>
        <p className="text-lg mb-8">Connect with friends and share your moments.</p>
